...
const Header = () => {
    ...
    <nav className="flex pl-8 pr-8 items-center max-w-7xl mx-auto justify-between w-full text-black p-4 sm:rounded-2xl bg-gradient-to-tr from-amber-300  to-amber-400 mb-10 sm:mt-4 rounded-none mt-0">
